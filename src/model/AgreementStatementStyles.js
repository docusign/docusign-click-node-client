...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DocusignClick.AgreementStatementStyles = factory(root.DocusignClick.ApiClient);
  }
  ...
  /**
   * The AgreementStatementStyles model module.
   * @module model/AgreementStatementStyles
   */

  /**
   * Constructs a new <code>AgreementStatementStyles</code>.
   * Control the display of the agreement statement.
   * @alias module:model/AgreementStatementStyles
   * @class
   */
  ...
  /**
   * Constructs a <code>AgreementStatementStyles</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AgreementStatementStyles} obj Optional instance to populate.
   * @return {module:model/AgreementStatementStyles} The populated <code>AgreementStatementStyles</code> instance.
   */
   ...
   * @member {module:model/AgreementStatementStyles.DisplayEnum} display
   */
